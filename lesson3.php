...
/*12. 
Написать программу для подсчета суммы чисел от 1 до 100.*/
$a = 1;
$b = 1;  //счетчик
while ($b<100) {
    $b++;
...
/*14. 
Вывести числа от 100 до 80, исключая число 90. Использовать два варианта циклов*/
// 1-ый способ
$x = 100;
while ($x>=80) {
    if ($x!=90) {
...
/*15. 
Вывести трехзначное число в обратном порядке*/
$number = 627;
