...
/*
5. Написать программу в которой происходит инициализация переменной и после этого переменная удаляется.
...
/*
6. Даны два вещественных числа. Определить какое из них больше, а какое меньше.  В решении использовать тернарную операцию;*/
$x = 10;
$y = 6;
...
/*
7. Написать программу вычисления стоимости покупки с учетом скидки. Скидка в 3% предоставляется, если сумма покупки больше 500 рублей,
...
/*
8. Написать программу, которая проверяет является ли четным число, заданное во входных параметрах.*/
$x = 4; // задаем число
$y = ($x%2 != 0) ? ($x . ' - число нечетное') : ($x . ' - число четное'); // проверяем
echo $y; // выводим

/*
9. Написать программу, которая 10 раз выводит на экран имя и фамилию.*/
...
/*
10. Написать программу, которая выводит на экран таблицу квадратов первых десяти целых чисел.*/    
$x = 0; // вводим переменную
...
/*
11. Написать программу для подсчета суммы чисел от 1 до 100.*/
$x = 0; // вводим переменную
...
/*
12. Вывести на экран все целые числа от 100 до 200 кратные 3*/
...
/*
13. Вывести числа от 100 до 80, исключая число 90. Использовать два варианта циклов*/
...
/*
14. В сберкассу на трёхпроцентный вклад положили S рублей.Какой станет сумма вклада через N лет.*/
function S($s, $n) {
    $x = 0; // кол-во лет
    while ($x < $n) {
        $x++; // подсчет лет
...
/*
16. Создайте массив mas, содержащий значения: 10,20,30,………90,100.*/
